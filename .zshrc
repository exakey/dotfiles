...
plugins=( git z fzf docker sudo zsh-syntax-highlighting )
...
alias       radio='clear && $GOPATH/sonicradio && clear'
alias      pngify='clear && $GOPATH/pngify && clear'
